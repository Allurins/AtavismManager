...
import {WorldMobSpawnTimeComponent} from '../entry/world-mob-spawn-time/world-mob-spawn-time.component';
...
export const tabs: Tab[] = [
  ...
  {
    id: TabTypes.WORLD_MOB_SPAWN_TIME,
    icon: 'mob_spawn.png',
    title: 'WORLD_MOB_SPAWN_TIME.TITLE',
    type: TabType.mob,
    component: WorldMobSpawnTimeComponent,
    locked: false,
  },
  {
