export const locale = {
  ...
  "CONFIRM": {
    ...
    "UPDATE_TITLE": "World Dynasty Editor has update",
    "UPDATE_TEXT": "World Dynasty Editor has available update, click on 'Download Update' button to download new patch",
  ...
  "PROFILES": {
    ...
    "TITLE": "Profiles",
    "TITLE_TOOLTIP": "Help [World Dynasty Wiki](https://unity.wiki.atavismonline.com) ",
    ...
    "DATABASE_TYPE": {
      ...
      "ATAVISM": "World Dynasty Database",
  ...
  "BONUS_SETTING": {
    ...
    "CODE": "Code",
    "CODE_HELP": "Choose the code you will use to reference this Bonus elsewhere inside of World Dynasty.",
    "VALUE": "Value",
  ...
  "DIALOGUE": {
    ...
    "AUDIOCLIP_HELP": "Choose a sound name that you have specified in the World Dynasty NPCAudio Manager (in the Login scene -> Scripts) to be played with this Dialogue.",
  ...
  "PATROL_PATH": {
    "TITLE": "Patrol Paths",
    "TITLE_TOOLTIP": "In this section you will define Patrol Paths that you can assign to individual mobs. Click this link for more information. [World Dynasty Wiki](https://unity.wiki.atavismonline.com) ",
  ...
  "SKILLS": {
    ...
    "SKILL_PROFILE_ID_HELP": "Choose the Skill profile from the list which can be defined in the Skill Profiles section in World Dynasty Editor.",
    "ASPECT": "Skill Class",
  ...
  "PLAYER_CHARACTER": {
    ...
    "SPRINT": "Sprint",
    "SPRINT_HELP": "Choose the ability which will be used for the player sprint effect. Sprint as any other key can be bound in the Login scene -> Scripts -> World Dynasty Settings component.",
    "DODGE": "Dodge",
    "DODGE_HELP": "Choose the ability which will be used for the player dodge effect. Dodge as any other key can be bound in the Login scene -> Scripts -> World Dynasty Settings component.",
  ...
  "CLAIM_PROFILE": {
    ...
    "TITLE_TOOLTIP": "In this section you will define profiles for areas within your game that can be claimed by a player as well as what can be put in those areas by the player. Click this link for more information. [World Dynasty Wiki](https://unity.wiki.atavismonline.com) ",
  ...
  "MOB_BEHAVIOR_PROFILE": {
    ...
    "ABILITY_INTERVAL_HELP": "Defines how often the World Dynasty server will try to use an ability",
    "MOB_TAG": "Mob tag",
    ...
    "LESS": "Less / More",
    "LESS_HELP": "Checked means that the World Dynasty will check if the value is lower, and unchecked means that it should be higher than specified value",
    "STAT_NAME": "Stat name",
    ...
    "PRIORITY": "Priority",
    "PRIORITY_HELP": "Defines priority for the ability. All priorities with the same Mob Ability Group are added, and the World Dynasty server will randomize one value from the range between 0 up to the sum of all priority values. Abilities that are on cooldown at a specific time will be excluded from this calculation",
    "ON_TARGET": "Present",
    ...
    "TARGET_ALLY_HELP": "Defines if World Dynasty should check the number of allies or enemies",
  ...
  "ITEM_AUDIO_PROFILE":{
    ...
    "USE_EVENT_HELP": "Name of audio for event defined in component World Dynasty InventoryAudioManager",
    "DRAG_BEGIN_EVENT": "Drag Begin Audio Event",
    "DRAG_BEGIN_EVENT_HELP": "Name of audio for event defined in component World Dynasty InventoryAudioManager",
    "DRAG_END_EVENT": "Drag End Audio Event",
    "DRAG_END_EVENT_HELP": "Name of audio for event defined in component World Dynasty InventoryAudioManager",
    "DELETE_EVENT": "Delete Audio Event",
    "DELETE_EVENT_HELP": "Name of audio for event defined in component World Dynasty InventoryAudioManager",
    "BROKE_EVENT": "Broke Audio Event",
    "BROKE_EVENT_HELP": "Name of audio for event defined in component World Dynasty InventoryAudioManager",
    "PICK_UP_EVENT": "Pick Up Audio Event",
    "PICK_UP_EVENT_HELP": "Name of audio for event defined in component World Dynasty InventoryAudioManager",
    "FALL_EVENT": "Fall Audio Event",
    "FALL_EVENT_HELP": "Name of audio for event defined in component World Dynasty InventoryAudioManager",
    "DROP_EVENT": "Drop Audio Event",
    "DROP_EVENT_HELP": "Name of audio for event defined in component World Dynasty InventoryAudioManager",
  },
  "STATS_PROFILE":{
    "TITLE": 'Stats Profile',
  ...
  "WORLD_MOB_SPAWN_TIME": {
    "TITLE": "Boss World Spawns",
    "TITLE_TOOLTIP": "Configure scheduled world boss spawns by time and weekday.",
    "SEARCH_PLACEHOLDER": "Search for a Boss World spawn",
    "ADD_TITLE": "Create a Boss World spawn",
    "EDIT_TITLE": "Update Boss World spawn",
    "NAME": "Spawn name",
    "MOB_TEMPLATE_ID": "Mob Template",
    "INSTANCE_ID": "Instance Id",
    "SPAWN_X": "Spawn X",
    "SPAWN_Y": "Spawn Y",
    "SPAWN_Z": "Spawn Z",
    "ORIENTATION_W": "Orientation W",
    "ROAM_RADIUS": "Roam Radius",
    "SPAWN_TIME": "Spawn Time",
    "DESPAWN_TIME": "Despawn Time",
    "TIMEZONE": "Timezone",
    "DAYS_OF_WEEK": "Days of week (1=Mon..7=Sun)",
    "ACTIVE": "Active",
    "RESPAWN_IF_KILLED": "Respawn if killed",
    "LAST_SPAWN_DATE": "Last spawn date"
  },
};
